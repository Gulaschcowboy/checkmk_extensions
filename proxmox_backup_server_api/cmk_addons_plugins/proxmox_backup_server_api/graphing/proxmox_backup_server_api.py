...
metric_proxmox_backup_server_api_removed_bytes = metrics.Metric(
    name="removed_bytes",
...
metric_proxmox_backup_server_api_disk_bytes = metrics.Metric(
    name="disk_bytes",
...
metric_proxmox_backup_server_api_removed_bad_chunks = metrics.Metric(
...
metric_proxmox_backup_server_api_still_bad_chunks = metrics.Metric(
...
metric_proxmox_backup_server_api_last_age = metrics.Metric(
    name="last_age",
